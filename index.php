            ...
            <article>
                <form method="post" action="save.php">
                    <label>Podaj adres e-mail
                        <input type="email" name="email" <?php isset($_SESSION['given_email']) ?  'value="'.$_SESSION['given_email']. '"' : ''?> >
                    </label>
                    <input type="submit" value="Zapisz się!">

                    <?php
                    //sprawdzenie czy ustawiona jest zmienna sesyjna niepoprwnego maila
